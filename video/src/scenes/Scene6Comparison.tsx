...
import { ComparisonSection } from '../website-components/ComparisonSection';
...
import voiceViAudio from '../audio/voice_vi_6.mp3';
...
type Scene6Props = { locale: Locale };

export const Scene6Comparison: React.FC<Scene6Props> = ({ locale }) => {
  ...
  return (
    <AbsoluteFill
      ...
      <Subtitle lines={buildSubtitleLines(sub[5], SCENE_DURATION_FRAMES)} />
    </AbsoluteFill>
  );
};
