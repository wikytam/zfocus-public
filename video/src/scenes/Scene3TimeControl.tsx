...
import { TimeControlCard } from '../website-components/TimeControlCard';
...
import voiceViAudio from '../audio/voice_vi_3.mp3';
...
type Scene3Props = { locale: Locale };

export const Scene3TimeControl: React.FC<Scene3Props> = ({ locale }) => {
  ...
  return (
    <AbsoluteFill
      ...
      <Subtitle lines={buildSubtitleLines(sub[2], SCENE_DURATION_FRAMES)} />
    </AbsoluteFill>
  );
};
