...
import { AdvancedActionsCard } from '../website-components/AdvancedActionsCard';
...
type Scene4Props = { locale: Locale };

export const Scene4AdvancedActions: React.FC<Scene4Props> = ({ locale }) => {
  ...
  return (
    <AbsoluteFill
      ...
      <div
        ...
        <AdvancedActionsCard t={t} />
      </div>
      <Subtitle lines={buildSubtitleLines(sub[3], SCENE_DURATION_FRAMES)} />
    </AbsoluteFill>
  );
};
